...
void setup() {
  ...
  //xTaskCreatePinnedToCore(Task1code, "Task2", 10000, NULL, 0, NULL,  0);
   delay(500);
  xTaskCreate(Read_AHT10_INA226,"Read_AHT10_INA226",4000,NULL,5,NULL);
   delay(500);
  ...
  xTaskCreate(check_Temp_Volts_Him,"check_Temp_Volts_Him",10000,NULL,6,NULL);
   delay(500);
  xTaskCreate(check_Temp_Volts_Him_12Hours,"check_Temp_Volts_Him_12Hours",10000,NULL,5,NULL);
   delay(500);   
  //////SSH_task_start
